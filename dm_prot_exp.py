...
genedata = pd.read_excel('dmdata.xlsx')
...
vae_gene.load_state_dict(torch.load('vae_dm_DP.pth'))
vae_methylation.load_state_dict(torch.load('vae_prot_DP.pth'))
...
print("\nEXPERIMENT : DNA METHYLATION + PREDICTED PROTEIN : \n")
...
print("\nEXPERIMENT : PROTEIN + PREDICTED DNA METHYLATION : \n")
